...
class SpatialOp(object):
    """
    usage : 
    This class is use to hack an issue with pyspatialite. pyspatialite object
    can not be use directly with pickle due to nested class ?
    """
    def __init__(self):
        pass


    def intersectSqlites(self,t1, t2, tmp, output, epsg, operation, keepfields, vectformat='SQLite'):
        from pyspatialite import dbapi2 as db
        tmpfile = []
