...
class iota_testStringManipulations(unittest.TestCase):
    ...
    def test_getTile(self):
        ...
        for currentTile in self.AllS2Tiles:
            try:
                fu.findCurrentTileInString(rString_head+currentTile+rString_tail,self.AllS2Tiles)
            except:
                S2 = False
        self.assertTrue(S2)
        L8 = True
        for currentTile in self.AllL8Tiles:
            try:
                fu.findCurrentTileInString(rString_head+currentTile+rString_tail,self.AllL8Tiles)
            except:
                L8 = False
        self.assertTrue(L8)
