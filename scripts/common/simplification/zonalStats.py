...
def zonal_stats_otb(vecteur, r_validity, r_classif, r_classifier, field, outwd, version, out, ndept, split=""):
    ...
    sample_selection = osof.otb_sample_selection(stack_raster,vecteur, field, poly_class_stats, outwd, float(version), split)
    timer.stop()
